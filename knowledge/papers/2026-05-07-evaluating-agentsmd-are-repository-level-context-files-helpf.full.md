...
source: other
type: full-text
parent: "[[2026-05-07-evaluating-agentsmd-are-repository-level-context-files-helpf]]"
ingested: 2026-05-07
...
@inproceedings{ gloaguen2026evaluating, title={Evaluating {AGENTS}.md: Are Repository-Level Context Files Helpful for Coding Agents?}, author={Thibaud Gloaguen and Niels M{"u}ndler and Mark Niklas Mueller and Veselin Raychev and Martin Vechev}, booktitle={ICLR 2026 Workshop on Memory for LLM-Based Agentic Systems}, year={2026}, url={https://openreview.net/forum?id=pLi3A8bscP} }